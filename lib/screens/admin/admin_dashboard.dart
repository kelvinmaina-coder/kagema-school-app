...
class _AdminDashboardState extends State<AdminDashboard> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 32),
                  _buildSectionLabel(theme, 'COMMAND SHORTCUTS'),
  ...
  Widget _buildOperationsTab(ThemeData theme, GeminiThemeExtension? gemini) {
    return ListView(
      ...
      children: [
        ...
        _operationTile(theme, 'Task Orchestrator', 'Assign neural duties to faculty', Icons.assignment_ind_rounded, Colors.deepOrange, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TaskManagementScreen()))),
        const SizedBox(height: 32),
        _buildSectionLabel(theme, 'ACADEMIC REPOSITORY'),
        _operationTile(theme, 'Exam Matrix', 'Schedule assessments & grades', Icons.quiz_rounded, Colors.orange, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ExamManagementScreen()))),
        _operationTile(theme, 'Academic Hub', 'Matrix of classes & subjects', Icons.auto_stories_rounded, Colors.indigo, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AcademicManagementScreen()))),
        ...
        _operationTile(theme, 'Bus Fleet', 'Transport routes & drivers', Icons.bus_alert_rounded, Colors.deepPurple, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TransportManagementScreen()))),
        _operationTile(theme, 'Library Nexus', 'Lending repository & history', Icons.local_library_rounded, Colors.blueGrey, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const LibraryManagementScreen()))),
        ...
        _operationTile(theme, 'Discipline Matrix', 'Behavioral incidents & logs', Icons.gavel_rounded, Colors.red, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const DisciplineManagementScreen()))),
        _operationTile(theme, 'Business Intel', 'Analytics & cloud reports', Icons.insights_rounded, Colors.cyan, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ReportsModuleScreen()))),
      ],
    );
  }
  ...
  Widget _buildSummaryStats(ThemeData theme, GeminiThemeExtension? gemini) {
    return Row(
      ...
      children: [
        _miniStat(theme, gemini, 'FACULTY', '${stats['staff'] ?? 0}', Colors.teal),
        _miniStat(theme, gemini, 'REVENUE', 'Ksh ${stats['totalFees'] ?? 0}', Colors.green),
  ...
  Widget _buildQuickActions(ThemeData theme, GeminiThemeExtension? gemini) { return GridView.count(shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), crossAxisCount: 2, crossAxisSpacing: 16, mainAxisSpacing: 16, childAspectRatio: 1.5, children: [_quickCard(theme, gemini, 'COMMAND HUB', Icons.hub_rounded, Colors.blue, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const UserManagementHub()))), _quickCard(theme, gemini, 'BULLETINS', Icons.campaign_rounded, Colors.pink, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CommunicationHubScreen())))]); }
